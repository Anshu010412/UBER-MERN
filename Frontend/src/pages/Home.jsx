...
const Home = () => {
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div
        ref={vehiclePanelRef}
        className="fixed w-full z-10 bottom-0 px-4 py-8 bg-white translate-y-full"
      >
        <h3 className="text-2xl mb-3 font-semibold">Choose A Vehicle</h3>

        <div className="flex border-2 mb-2 rounded-xl active:border-black w-full p-3 items-center justify-between">
          <img
            className="h-12"
        ...
        <div className="flex border-2 mb-2 rounded-xl active:border-black w-full p-3 items-center justify-between">
          ...
          <div className=" w-1/2">
            <h4 className="font-bold text-lg">
              Auto{" "}
              <span className="ml-1">
                <i className="text-md font-medium ri-user-fill"></i>3
              </span>
            </h4>
            <h5 className="font-medium text-sm">3 Mins Away</h5>
            <p className="font-base text-xs text-gray-800 ">Affordable Rides</p>
          </div>
          <h2 className="font-semibold text-lg">₹165.5</h2>
        </div>
        ...
        <div className="flex border-2 mb-2 rounded-xl active:border-black w-full p-3 items-center justify-between">
          ...
          <div className="w-1/2">
            <h4 className="font-bold text-lg">
              MotorCycle{" "}
              <span className="ml-1">
                <i className="text-md font-medium ri-user-fill"></i>2
              </span>
            </h4>
            <h5 className="font-medium text-sm">2 Mins Away</h5>
            <p className="font-base text-xs text-gray-800 ">
              Wear Helmet, Safely Rides
            </p>
          </div>
          <h2 className="font-semibold text-lg">₹100.50</h2>
        </div>
      </div>
    </div>
  );
