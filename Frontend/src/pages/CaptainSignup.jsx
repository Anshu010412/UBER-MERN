    ...
    <div className="py-5 px-5 h-screen flex flex-col justify-between">
      <div>
        ...
        <form onSubmit={submitHandler}>
          <h3 className="text-lg font-medium mb-2 w-full">Captain Name </h3>
          ...
          <h3 className="text-lg font-medium mb-2 w-full">Captain Email</h3>
          <input
            required
            value={email}
          ...
          <h3 className="text-lg font-medium mb-2 w-full"> Password</h3>
          <input
            required
            value={password}
